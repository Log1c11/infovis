            ...
            <Row className='justify-content-md-center'>
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
                        ...
                        height={innerHeightScatter} width={innerWidth} x={tooltipX} y={tooltipY} setTooltipX={setTooltipX} setTooltipY={setTooltipY} selectedPoint={selectedPoint} setSelectedPoint={setSelectedPoint} selectedStation={selectedStation} setSelectedStation={setSelectedStation}/>
                    </svg>
                </Col>
                <Col>
                    <svg width={WIDTH} height={HEIGHT}>
